...
Formato de saída: tabela markdown com colunas [ator, tipo (humano/IA), papel na jornada, ponto de entrada, ponto de saída, evidência/fonte].
Critérios de fonte: documentos oficiais (gov.br, Caixa, MTE), relatos do TCU/CGU, papers acadêmicos, jornalismo investigativo. Recusar blogs sem autoria e o próprio chatbot do site.
